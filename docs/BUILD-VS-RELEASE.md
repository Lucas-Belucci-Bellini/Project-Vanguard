...
Em 2026-08-28, o commit funcional `4b3855b` foi publicado em `main` com tracking GPS experimental em segundo plano, plugin nativo sincronizado e manifesto Android revisado. O CI `33134403140` concluiu com sucesso. O build local gerou `app-debug.apk` de 8.816.910 bytes, SHA-256 `afbf0c0091e9b8e02fcdfff2e31c48f0b969a3dea508afd1ea6b7be04fc96db5`. Esse hash identifica um **artifact debug/teste**, não assinatura, candidate, release ou validação física. A única release pública continua `v1.0.0-rc.2`.

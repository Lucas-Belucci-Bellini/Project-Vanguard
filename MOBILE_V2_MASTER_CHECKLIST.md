...
| OMEGA-007 | Map | Touch/maps | Mapa MapLibre, centralização, gestos e tiles preparados | `src/pages/mapa.js`, planner/SW | build e testes do planner/SW | Node/CI | `MOBILE_V2_TEST_MATRIX.md` | IN_PROGRESS | touch, cobertura e quota físicas |
| OMEGA-008 | Offline | Prepared maps | Select/prepare/download/verify/use local | planner até 256 URLs e status local | testes planner/SW | Node/CI | ADR-0011/0012 | IN_PROGRESS | quota, tiles e modo avião |

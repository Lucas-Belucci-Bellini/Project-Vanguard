...
- Unidade atual validada localmente com 131 testes, build web, planner de tiles, audit de produção, sync Android/iOS e APK debug; commit/CI serão registrados após o push.

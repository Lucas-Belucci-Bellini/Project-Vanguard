...
export const ROTAS = [
  ...
  { hash: '#/trilhas', titulo: 'Trilhas', icone: '≡', carregar: () => import('../pages/trilhas.js').then((m) => m.trilhasPage) },
  ...
  { hash: '#/atualizacoes', titulo: 'Atualizações', icone: '↑', carregar: () => import('../pages/atualizacoes.js').then((m) => m.atualizacoesPage), secundária: true },

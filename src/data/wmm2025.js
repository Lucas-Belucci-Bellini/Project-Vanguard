/* ⚠️ ARQUIVO GERADO — não edite à mão (scripts/gerar-wmm.mjs).
 *
 * Coeficientes do World Magnetic Model 2025, lidos do arquivo oficial
 * vendor/wmm/WMM.COF (SHA-256 06791cd95faba7bdf4a709808f2715a53fe689b29c23b9886bc2196fa9b3eb13).
 *
...
export const WMM_EPOCA = 2025;

/** Nome do modelo, como está no cabeçalho do arquivo oficial. */
export const WMM_MODELO = "WMM-2025";

/** Data de emissão declarada no cabeçalho (MM/DD/AAAA, como no arquivo). */
export const WMM_DATA_MODELO = "11/13/2024";

/** Grau/ordem máximos da expansão. */
export const WMM_GRAU_MAXIMO = 12;

/** O modelo vale desta época até cinco anos depois; fora disso não se extrapola. */
export const WMM_VALIDADE = Object.freeze({ inicio: 2025, fim: 2030 });

/** SHA-256 do WMM.COF de onde estes números saíram. */
export const WMM_COF_SHA256 = "06791cd95faba7bdf4a709808f2715a53fe689b29c23b9886bc2196fa9b3eb13";

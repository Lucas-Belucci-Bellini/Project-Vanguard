...
| **Tests** | `npm test`: 223 testes aprovados; inclui os dezessete casos de ciclo de vida do dataset, entre eles os quatro pontos de interrupção da ativação e a recusa do catálogo real de fontes |

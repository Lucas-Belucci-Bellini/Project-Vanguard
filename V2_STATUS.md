...
| **Current Task** | Validar em aparelhos o lifecycle e o cleanup de centralização; usar `DEVICE_CAPABILITIES.md` e `MOBILE_V2_RELEASE_CANDIDATE.md` para os gates físicos sem assumir background GPS |
| **Last Completed Task** | Cleanup da centralização manual no mapa, callbacks tardios e Wake Lock após desmontagem; `6d7c7fb`, CI pendente desta rodada |

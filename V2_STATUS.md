...
| **Last Completed Task** | Diagnóstico passou a exibir capacidades observáveis de GPS, orientação, storage, rede, bateria e compartilhamento em estados explícitos; commit `4f8e20a` |
...
| **Tests** | `npm test`: 138 testes aprovados; `node --check public/sw.js`, `git diff --check` e auditoria de produção aprovados; capacidades e diagnóstico `lat/lon` cobertos |
...
| **Documentation** | README, roadmap, notas de release, checklist mobile, plano de campo, atualização, tag, segurança, memória V2, memória MOBILE_V2, ADR-0005/0006/0007/0008/0009/0010/0011/0012/0013/0014, referências WCAG/performance e validações do Diagnóstico/Mapa/Home/tiles/SW/capacidades versionados |
| **Release Readiness** | `BLOCKED`: candidate pública `v1.0.0-rc.2`; tag final `v1.0.0` não criada |
| **Main** | `4f8e20a feat(v2): expor capacidades locais`; testes locais: 138 aprovados; CI deste commit será registrado após conclusão |

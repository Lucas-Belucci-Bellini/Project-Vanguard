...
| **Current Task** | Usar `DEVICE_CAPABILITIES.md` para orientar T-005A e os demais gates físicos de GPS, lifecycle, modo avião, persistência, sensores, performance e bateria; não assumir background GPS |
| **Last Completed Task** | Fixo manual de maior precisão no botão Centralizar, mantendo watcher de cidade econômico; `e7bfb10`, CI `33128218221` |

...
| D-007 | Legado balístico é uma wiki/ambiente separado de Arma 3 e `LEGACY-RESTRICTED` | Foi criado somente para testes e simulação dentro do videogame, nunca para uso real | Não faz parte do Vanguard Field civil; não adaptar para ambientes, equipamentos, treinamento, armamento ou operações reais |

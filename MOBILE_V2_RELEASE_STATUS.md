...
|---|---|---|---|
| Código em `main` | Aprovado | `main` publicada no commit funcional `06cc503`; CI `33131026249` concluído com sucesso | continuar gates sem regressão |
| Web/PWA build | Aprovado | `npm run build` e CI `33131026249`; manifesto e transação de dataset validados sem dataset empacotado | instalação/modo avião/update posterior físicos |
...
| Candidate V2 documental | `NOT READY / BLOCKED` | `MOBILE_V2_RELEASE_CANDIDATE.md` registra o snapshot funcional `06cc503`; nenhuma tag candidate V2 | não chamar o documento de release publicada |

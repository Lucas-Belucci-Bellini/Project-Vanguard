...
|---|---|---|---|
| Código em `main` | Aprovado | `main` publicada no commit funcional `57a387a`; CI `33130481662` concluído com sucesso | continuar gates sem regressão |
| Web/PWA build | Aprovado | `npm run build`, `npm run mobile:android:debug` e CI `33130481662`; manifesto de dataset validado sem dataset empacotado | instalação/modo avião/update posterior físicos |
...
| Candidate V2 documental | `NOT READY / BLOCKED` | `MOBILE_V2_RELEASE_CANDIDATE.md` registra o snapshot funcional `57a387a`; nenhuma tag candidate V2 | não chamar o documento de release publicada |

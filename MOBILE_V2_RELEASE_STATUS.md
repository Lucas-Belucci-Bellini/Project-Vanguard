...
> Atualizado em 2026-08-27. Este documento separa build, artifact, signing, instalação, validação e release pública. O registro detalhado do snapshot candidate está em `MOBILE_V2_RELEASE_CANDIDATE.md`.

| Gate | Estado | Evidência | Próximo requisito |
|---|---|---|---|
| Código em `main` | Aprovado | `main` limpa; snapshot atual `d8bf3a1`; CIs recentes verdes | continuar gates sem regressão |
...
| Candidate V2 documental | `NOT READY / BLOCKED` | `MOBILE_V2_RELEASE_CANDIDATE.md` registra o snapshot `d8bf3a1`; nenhuma tag candidate V2 | não chamar o documento de release publicada |

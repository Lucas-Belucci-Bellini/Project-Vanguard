...
| B-006 | Diagnóstico dedicado ainda requer validação em dispositivos | Média | `#/diagnostico`, 8 testes e preview limpo; sem telemetria | Validar em navegador instalado e aparelhos reais | IN_PROGRESS |
